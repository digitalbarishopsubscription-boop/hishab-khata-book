...
const groups: { label: string; items: { title: string; url: string; icon: any }[] }[] = [
  {
    ...
    items: [
      ...
      { title: "এআই সহকারী", url: "/dashboard", icon: Bot },
    ],
  },
  {
    label: "ব্যবসায়িক",
  ...
  },
  {
    label: "ব্যবস্থাপনা",
    items: [
      { title: "কর্মচারী", url: "/dashboard", icon: UserCog },
      { title: "ব্রাঞ্চ", url: "/dashboard", icon: Building2 },
      ...
      { title: "সেটিংস", url: "/dashboard", icon: Settings },
    ],
  },
];
